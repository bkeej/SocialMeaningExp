...
these days is by forcing myself to code up an implementation. 🤫

Some things I'll be adding in the near future:

-   Costs and temperatures (may require `listen` and `tell` like functionality,
    making the underlying monadic structures even more `Writer`-y).
